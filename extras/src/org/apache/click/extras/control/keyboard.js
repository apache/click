 ...
 * usage instructions.
 *
 * Version click - 22 Apr, 2008
 *   - added //<script type="text/javascript">var keyboard_png_path="{0}/click/keyboard.png";</script>
 *     to the call to work with click context paths, and used the keyboard_png_path here.  
 *
