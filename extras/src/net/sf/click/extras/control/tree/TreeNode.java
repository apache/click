...
/**
 * This class is the implementation of a {@link net.sf.click.extras.control.tree.Tree} model.
 *
 * <p/>TreeNode's are used to store hierarchical data representations for example 
 * directories, subdirectories and files.
 *
 * <p/>Nodes must have an unique id and can store a user defined value of type 
 * {@link java.lang.Object}.
 *
 * <p/>Nodes contain a reference to their parent node as well as their children.
 *
 * <p/><strong>Note:</strong> Since each TreeNode must have a unique id within 
