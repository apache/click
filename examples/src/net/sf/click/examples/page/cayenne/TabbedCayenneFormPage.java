 ...
 */
public class TabbedCayenneFormPage extends BorderPage {

    protected static final int MAX_TABLE_SIZE = 5;

    public TabbedCayenneForm form = new TabbedCayenneForm();
    ...
    public TabbedCayenneFormPage() {
        ...
        form.setBackgroundColor("#eee");
        form.setTabHeight("155px");
        form.setTabWidth("305px");

        FieldSet clientFieldSet = new FieldSet("Client");
        form.addTabSheet(clientFieldSet);
        ...
        form.addTabSheet(addressFieldSet);
        ...
        table.setAttribute("style", "margin-top:1em;");
