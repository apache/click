...
/**
 * Utility methods for handling entities. Separate from the Entity class mainly
 * because of dependency on the ORM-associated ObjectRetrievalFailureException.
 * 
 * @author Juergen Hoeller
 * @since 29.10.2003
 * @see org.springframework.samples.petclinic.model.Entity
 */
public abstract class EntityUtils {
     ...
     */
    public static Entity getById(Collection entities,
                                 Class entityClass,
                                 int entityId)
