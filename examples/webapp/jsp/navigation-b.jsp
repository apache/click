...
<pre class="javaCode">
    setForward(<span class='st'>"/navigation-a.htm"</span>);
</pre>
...
<pre class="javaCode">
    setRedirect(<span class='st'>"/navigation-a.htm"</span>);
</pre>
...
<pre class="javaCode">
    setRedirect(<span class='st'>"/navigation-a.htm?param="</span> + param);
</pre>
...
Please also see the <a href="pageflow/start-page.htm">Page Flow</a> example.