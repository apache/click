 ...
 */
public class ClickHeadersEditor extends AbstractFormEditor {
	...
	public void initModel(IStructuredModel model){
		...
		acceptElements.add(ClickPlugin.TAG_HEADER);
		...
		viewer.addSelectionChangedListener(new ISelectionChangedListener(){
			public void selectionChanged(SelectionChangedEvent event){
				...
				if(obj!=null && obj instanceof IDOMElement){
					if(((IDOMElement)obj).getNodeName().equals(ClickPlugin.TAG_HEADER)){
						IAttributeEditor editor = new HeaderAttributeEditor();
