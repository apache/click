...
/**
 * A normal page which demonstrates the use of actions. There are three actions
 * one for feeding an autocomplete textfield the other to demonstrate a dynamic
 * image and a third which demonstrates a link which displays a customers.
...
public class PlainAjaxActionPage extends AjaxPage {
    ...
    public static final AjaxAction sampleAction = new AjaxAction() {
        ...
        public void doExecute(Page page) {
            ...
            result += "<br/>Id RequestParam: "
                    + page.getContext().getRequestParameter("id");
    ...
    public static final AjaxAction sampleAction2 = new AjaxAction() {
        ...
        public void doExecute(Page page) {
            ...
            result += "Page class: " + page.getClass();
            result += "<br/>name RequestParam: "
                    + page.getContext().getRequestParameter("name");
            page.addModel("result", result);
        }
    };
    ...
    public void onInitPage() {
        ...
        ActionLink al = new ProcessActionLink("actionLink", this,
                "onActionLinkClicked");
    ...
    public class ProcessActionLink extends ActionLink {
        ...
        public boolean onProcess() {
            PlainAjaxActionPage.this.addModel("onActionLinkProcess",
                    Boolean.TRUE);
