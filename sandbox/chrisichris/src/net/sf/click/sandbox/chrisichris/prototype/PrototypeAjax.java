...
public class PrototypeAjax extends Prototype implements Cloneable {
    ...
    /**
     * JS function to execute when the AJAX request is complete. the funciton
     ...
     * JS function to execute when the AJAX request is complete. the funciton
     * will get the transport (with responseText) and wheter json is send or not
     * the key is either a response code (202), Sucess, Failure or one of the
     * REUEST_EVENT constants the value is the JS function to execute (putAll to
     * options with 'on'+key - directly put in options not as sub-map)
     */
    ...
    /**
     * option wheter scripts shold be evaluated if contained in response.
     */
    protected boolean evalScripts = true;
    ...
    /**
     * The container to use in case of success for update passed in as as value
     * in container map key = success. See ln 750
     */
    protected String containerSuccess;

    /**
     * The container to use in case of failure for update. passed in as value in
     * container map key = failure
     *
     */
    protected String containerFailure;

    /**
     * The requestHeaders PROTOTYPE needs an array where the first is the name
     * the second is the value. (line 679) Put as list in options
     */
    ...
    /**
     * The html elementId of the element which should be updated with the succes
     * and failure result of the AJAX call.
     *
     * @param elementId
     *            the elementId.
     *
    ...
    /**
     * The html elementId of the element which should be updated whith the
     * result of the ajax call in case of succes.
     *
     * @param elementId
     *            html elementId
     * @return this
    ...
    /**
     * The html elementId of the element which should be updated with the result
     * of the ajax call in case of failure.
     *
     * @param elementId
     *            html id
     * @return this
    ...
    /**
     * Returns the JS function to call in case of the given http code returned
     * from the server.
     *
     * @param code
     *            a code ie 201
    ...
    /**
     * Register the given JS function to be called if the server response has
     * the given result code.
     *
     * @param code
     *            the result code ie 201
     * @param js
     ...
     *
     * @param method
     *            if post it is post otherwise set to get
     * @return this
     */
    ...
    /**
     * In case of {@link #setUpdate(String)} where to insert the result.
     *
    ...
    /**
     * In case of {@link #setUpdate(String)} where to insert the result. This is
     * one of the PrototypeControl.INSERT constants. Default is to replace the
     * content.
     *
     * @param insertion
     *            one of the PrototypeControl.INSERT_ constants or null.
     * @return this
     */
    public PrototypeAjax setInsertion(String insertion) {
        this.insertion = insertion;
        return this;
    }

    /**
     * JS code to execute in case an exception happens in one of the other event
     * handlers.
     *
     * @return js function
     */
     ...
     *
     * @return a JS expression for the String of parameters
     */
     ...
     * @param valueJS
     *            JS to caculate the value of the parameter
     * @return this
     */
     ...
     *            of request header
     * @param value
     *            of request header if null the header is removed if present
     * @return this
     */
    ...
    /**
     * JS code to execute when the AJAX Request enters interactive state.
     *
     * @return code
     */
    ...
    public String createJSOptions() {
        ...
        for (Iterator it = options.entrySet().iterator(); it.hasNext();) {
            Map.Entry/* <String,String> */option =
        ...
        for (Iterator it = completeCode.entrySet().iterator(); it.hasNext();) {
            Map.Entry/* <Integer,String> */option =
        ...
        if (!requestHeaders.isEmpty()) {
            ...
            for (Iterator it = requestHeaders.entrySet().iterator(); it
                    .hasNext();) {
    ...
    /**
     * Returns "eval(request.responseText)" which can be called in onComplete to
     * evaluate a javascript returned in case of multiple updates.
     *
     * @return 'val(request.responseText)'
     */
    ...
    /**
     * returns the toJS()+;return false; typcially used in in onClick
     * attributes.
     *
     * @return JS
     */
