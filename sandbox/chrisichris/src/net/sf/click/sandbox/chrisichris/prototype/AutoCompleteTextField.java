...
/**
 * A TextField combined with a scriptacoulus autocompleter. While the user enters a value into the TextField
 * an AjaxRequest is done to provide an unordered list for proposed values.
 * <p>
 * Typically the request is send to an AjaxAction which provides the ul. The AjaxAction is provided in the
 * constructor or through {@link #setAjaxAction(AjaxAction)}. There is the default AjaxAction 
 * AutocompleteTextField.Action which does this. 
 * </p>
 * <p>
 * This class is basicly a generater for script.aculo.us to see a full description with examples see
 * <a href="http://wiki.script.aculo.us/scriptaculous/show/Autocompletion>
...
public class AutoCompleteTextField extends TextField{
     ...
     * @param name
     * @param required
     * @param AjaxAction the action which renders the ul response
     */
     ...
     * @param AjaxAction the action which renders the ul response
     */
    public AutoCompleteTextField(String name, String label, boolean required, AjaxAction ac) {
     ...
     * @param AjaxAction the action which renders the ul response
     */
    public AutoCompleteTextField(String name, String label, int size, AjaxAction ac) {
    ...
    /////////////////////////7
    //code
    /** Set the AjaxAction which should be called to get the autocomplete propsals.
     * @param ajaxAction The ajaxAction to set.
     */
    ...
    ////////////////////////////////
    /**
     * The url to send the Ajax request for the update content to.
     * 
     * @return
     */
    ...
    /**
     * The url to send the Ajax request for the updated content to.
     * The request will be send with the id of the textfield as parameter 
     * @param url
     * @return
     */
     ...
     * The number of chars entered to start autocompletition.
     * Default is 1
     * @param minChars number of chars
     */
    ...
    /**
     * Set to enable tokenized autocompletition. Each time
     * a token is entered in the autocompletiton will be triggered
     * to fullfill the token. Default is null (not enabled).
     * @param tokens the tokens or null
     */
    ...
    /**
     * The html-id of the div which shows the autocompletion
     * selection.
     * @return id
     */
    ...
    /**
     * The html-class of the div which shows the autocompletion
     * selection 
     * @return html class
     */
    ...
    /**
     * The javascript tag &lt;script&gt; which
     * register an Ajax.Autocompleter for this TextField.
     * @return the JS tag
     */
    public String getAutocompleteJS(){
        ...
        if(actionUrl == null) {
            ...
            actionUrl = ajaxAction.getUrl(this.getContext());
        }
    ...
    /**
     * The div tag which represents the proposals for this
     * autocomplete.
     * @return
     */
    public String getDropdownDiv(){
        String ret = "<div id=\""+getDropDownDivId()+"\" class=\""+getDropDownDivClass()+"\"></div>";
        return ret;
    }
    
    /**
     * A convinience AjaxAction which renders the response for an AutoCompleteTextField. NOTE:
     * The action is executed concurrently.
     * A scriptacoulous autocompleter expects as a response an unordered list of the form:
     * <pre>
     * &lt;ul&gt;
     *   &lt;li&gt;
     ...
     * </pre>
     *         
     * Override {@link #getData(String)} to provide the data to be returned in the list.
     * Override {@link #getInputString(Object)} to customize the proposed string for each
     * value in the List returned from {@link #getData(String)}. Override
     * {@link #getDescriptionString(Object)} to provide the (optional) additional description
     * text for each value in the list.  
     * @author Christian Essl
     *
     */
    public static class Action extends AjaxAction {

        private final static List EMTPY_DATA 
                                    = Arrays.asList(new String[]{"Please provide data in " +
        ...
        protected void doExecute(Page page) {
            String paramIn = page.getContext().getRequestParameter(REQUEST_PARAM);
            if(paramIn == null) {
        ...
        /**
         * Renders the unordered list for the given . To do this calls out to {@link #getData(String)}
         * and with each item in the returned list to {@link #getInputString(Object)}
         * and to {@link #getDescriptionString(Object)}.
         * @param paramIn the value the user has up to now entered in the text-field.
        ...
        /**
         * A list of data objects for the given param. Each item of the returned list is given to 
         * {@link #getInputString(Object)} and {@link #getDescriptionString(Object)}
         * to render the proposed value.  By default returns an empty list.
         * @param param the value currently typed into the AutoCompleteTextField
        ...
        /**
         * Renders the value which is proposed to the user to enter in the autocomplete TextField.
         * By default return value.toString()
         * @param value item from the list returned from {@link #getData(String)}
         * @return
         */
         ...
         * @param value item form the list returned form {@link #getData(String)
