...
public class AjaxActionLink extends ActionLink {
     ...
     * @param ac the AjaxAction or null
     * @return
     */
    ...
    /**
     * Same as {@link ActionLink#getHref()} or '#' if {@link #getEnableHref()} is false;
     ...
     * </pre>
     * @param value value to send as ActionValue (toString() is used).
     * @return JS script
     */
     ...
     * @param str one of the static values of {@link Prototype}
     */
    ...
    /**
     * Html element-id of the element which should be updated with the html returned from 
     * the ajax-response.
    ...
    /**
     * Html element-id of the element which should be updated with the html returned from 
     * the ajax-response with a failure.
     * @param elementId html-element id
     */
    ...
    /**
     * Id of an html tag which should be made visible during the execution of a request.
     * @param id element id
     */
