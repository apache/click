 ...
 */
public class ClickPagesEditor extends AbstractFormEditor {
	...
	public void initModel(IStructuredModel model){
		...
		headerSection.setText(ClickPlugin.getString("editor.clickXML.pages"));
			...
			public void selectionChanged(SelectionChangedEvent event){
				...
				if(obj!=null && obj instanceof IDOMElement){
					...
					if(((IDOMElement)obj).getNodeName().equals(ClickPlugin.TAG_PAGES)){
						IAttributeEditor editor = new PagesAttributeEditor();
						currentEditor = editor.createForm(toolkit, right, (IDOMElement)obj);
					}
				}
				right.layout();
		...
		deleteAction = new ElementRemoveAction();
		menu.add(newMenu);
