...
public class CheckboxTreePage extends BorderPage {
    ...
    private Submit cancelSubmit;

    protected Tree createTree() {
        CheckboxTree tree = new CheckboxTree("checkboxTree" );
        return tree;
    }
    ...
    public void onInit() {
        ...
        okSubmit = new Submit("okSubmit", "Select", this, "onSubmitClick");
        cancelSubmit = new Submit("cancelSubmit", "Cancel",  this, "onCancelClick");
        form.add(okSubmit);
